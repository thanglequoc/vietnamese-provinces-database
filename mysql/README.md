...
The `gis/` subfolder contains chunked GIS import scripts (`MySQL` part files `*-part-NN.sql`) plus a `.manifest` file listing the chunks in order. Import each chunk in order after importing the base script.
