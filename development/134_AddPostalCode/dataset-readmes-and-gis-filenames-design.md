...
The mongodb `output/mongodb/gis/README.md` (already generated by
`writeMongoGISReadme`) stays as-is — it documents the GIS subfolder.
...
- **README timing**: READMEs are written at the end of each writer's
  ...
  GIS subfolder contents are described, not listed with sizes.
